...
public enum BaseResultCode implements IResultCode {
    ...
    LOGIN_FAIL("00410", "登录失败"),

    LOGIN_SUCCESS("00411", "登录成功"),
...
export enum errorCode  {
  ...
  FORBIDDEN = '00403',
  NOT_FOUND = '00404',
  METHOD_NOT_SUPPORTED = '00405',
  PARAM_MISS = '00410',
  PARAM_TYPE_ERROR = '00411',
...
export enum errorMsg {
  ...
  FORBIDDEN = '请求被拒绝',
  NOT_FOUND = '请求未找到',
  METHOD_NOT_SUPPORTED = '不支持当前请求方法',
  MEDIA_TYPE_NOT_SUPPORTED = '不支持当前媒体类型',
